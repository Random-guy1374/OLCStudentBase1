...
# with open("q1_greeting.txt","r") as f:
#     content = f.read()
#     print(content)    
...
# with open("q2_note.txt","w") as f:
#     f.write("Today I learnt how to write to a file.")
# with open("q2_note.txt","r") as f:
#     content = f.read()
#     print(content)
...
# with open("q3_diary.txt","a") as f:
#     f.write("\nI also revised Python at night.")
# with open("q3_diary.txt","r") as f:
#     content = f.read()
#     print(content)
...
# with open("q4_fruits.txt","r") as f:
#     content = f.readlines()
# print(content)
# print(len(content))
...
# for numpass in num_list:
#     if numpass >= 50:
#         count += 1
# print("Number of people passing:",count)
...
# with open("q6_names.txt","r") as f:
#     content = f.readlines()
# print(content)
# with open("proper_names.txt","a") as f:
#     for name in content:
#         f.write(name.title())
# with open("proper_names.txt","r") as f:
#     content2 = f.read()
# print(content2)
...
# ---------------------------------------------------------
# temp_list = []
# with open("q7_temperatures.txt","r") as f:
#     content = f.readlines()
# print(content)
# for num in content:
#     if int(num[:2]) >= 30:
...
# with open("hot_days.txt","a") as f:
#     f.writelines(temp_list)
# print("Number of hot days:",len(temp_list))
...
# dict = {}
# with open("q8_animal_names.txt","r") as f:
#     content = f.read().split(",")
# with open("q8_animal_sounds.txt","r") as f:
#     content2 = f.read().split(",")

# print(content)
# print(content2)
# for i in range(len(content)):
#     dict[content[i]] = content2[i]
# print(dict)
