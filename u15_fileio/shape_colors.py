...
def output_result(shape_input):
    while shape_input not in dic:
        shape_input = input("Shape not found\nEnter a shape again: ")
    last = dic[shape_input]
    return shape_input, last
ask = input("Enter a shape : ")
result2 = output_result(ask)
print(f"The colour of the {result2[0]} is {result2[1]}")
