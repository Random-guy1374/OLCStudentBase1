...
# sum = 0
# while True:
#     ask = input("Enter (enter END to quit): ")
#     if ask.lower() == "end":
#         print("Total =",sum)
#         break
#     ask = int(ask)
...
# sum2 = 0
# while True:
#     ask2 = int(input("Enter (enter 0 to quit): "))
#     if ask2 == 0:
#         print("Total =",sum2)
#         break
#     if ask2 > 0:
...
# while True:   
#     if len(username) < 5:
#         print("Invalid",username,"is too short")
#         username = input("Enter a username: ")
#     elif len(username) > 12:
#         print("Invalid",username,"is too long")
#         username = input("Enter a username: ")
#     else: 
...
#     if score < 0:
#         print("Invalid score must be postive")
#     elif score > 100:
#         print("Invalid score must be less than a 100")
#     else:
