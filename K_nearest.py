...
# leaf_len = float(input("Enter the length of leaf: "))
# leaf_wid = float(input("Enter the width of leaf: "))

# for x in plant_records:
#     plant = plant_records[x]
#     old_len = float(plant[0])
#     old_wid = float(plant[1])
#     distance = math.sqrt((leaf_len - old_len) ** 2 + (leaf_wid - old_wid) ** 2)
    
#     if distance <= short:
#         short = distance
#         predict_plant = plant[2]
    
# print("Predicted plane:",predict_plant)
